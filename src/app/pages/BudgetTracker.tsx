      ...
      return (
        <div className="bg-[#1C2128] border border-white/[0.1] rounded-lg p-2.5 text-xs shadow-xl">
          ...
          {payload.map((p: any, i: number) => (
            <p key={i} className="tabular-nums font-medium" style={{ color: p.fill, fontFamily: "'DM Mono', monospace" }}>
              {p.name}: ₦{p.value}B
            </p>
          ))}
        </div>
        ...
        <div className="space-y-4">
          <CivicCard className="p-4">
            ...
            <button
              ...
              className="w-full border-2 border-dashed border-[#1E8A5F]/30 rounded-xl p-8 flex flex-col items-center gap-3 text-center bg-[#1E8A5F]/[0.03] active:bg-[#1E8A5F]/[0.08] transition-all hover:border-[#1E8A5F]/60"
            >
              ...
              <div>
                <p className="text-[#E8EDF2] text-sm font-medium" style={{ fontFamily: "'Sora', sans-serif" }}>
                  {t("budgetUpload")}
                </p>
                <p className="text-[#8B949E] text-xs mt-1">{t("budgetDrag")}</p>
              </div>
              <span
                className="text-[10px] text-[#8B949E] bg-[#21262D] px-3 py-1 rounded-full border border-white/[0.06]"
          ...
          <CivicCard className="p-4">
            <p className="text-[#8B949E] text-[10px] uppercase tracking-widest mb-3" style={{ fontFamily: "'DM Mono', monospace" }}>
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-3 mb-2.5 last:mb-0">
                <div className="w-5 h-5 rounded-full bg-[#1E8A5F]/15 border border-[#1E8A5F]/35 flex items-center justify-center shrink-0">
                  <span className="text-[#1E8A5F] text-[9px] font-bold" style={{ fontFamily: "'DM Mono', monospace" }}>
                    {i + 1}
                  </span>
                </div>
        ...
        <div className="space-y-4">
          <CivicCard className="p-6">
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div>
                <h3 className="text-[#E8EDF2] text-sm font-semibold mb-1" style={{ fontFamily: "'Sora', sans-serif" }}>
                  {t("budgetAnalyzing")}
                </h3>
              ...
              <div className="w-full bg-[#21262D] rounded-full h-2 overflow-hidden border border-white/[0.04]">
                <div
                  className="bg-[#1E8A5F] h-full rounded-full transition-all duration-100"
                  style={{ width: `${progress}%` }}
                />
              </div>
              <p className="text-[#8B949E] text-[10px] tabular-nums" style={{ fontFamily: "'DM Mono', monospace" }}>
                {progress}% completed
              </p>
            </div>
          </CivicCard>
      ...
      {state === "results" && (
        <div className="space-y-4 slide-up">
          ...
          <div className="bg-[#E3433D]/10 border border-[#E3433D]/40 rounded-xl p-3.5 flex items-start gap-3 shadow-md">
            ...
            <div>
              <p className="text-[#E3433D] text-xs font-bold mb-1" style={{ fontFamily: "'Sora', sans-serif" }}>
                {t("budgetAlert")}
              </p>
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="h-1.5 bg-[#21262D] rounded-full overflow-hidden border border-white/[0.03]">
                      <div
                        className={`h-full rounded-full ${isCritical ? "bg-[#E3433D]" : "bg-[#1E8A5F]"}`}
                        style={{ width: `${(d.actual / d.allocated) * 100}%` }}
                      />
                    </div>
                  </div>
                  <span
          ...
          <CivicCard severity="critical" className="p-4">
            ...
            <p className="text-[#8B949E] text-[10px] mt-3.5 pt-3 border-t border-white/[0.06] font-medium" style={{ fontFamily: "'DM Mono', monospace" }}>
              {t("budgetSrc")}
            </p>
          </CivicCard>
